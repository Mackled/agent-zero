...
class BrowserAgent(Tool):
    ...
    async def execute(self, message="", reset="", **kwargs):
        ...
        message = SecretsManager.get_instance().mask_values(message, placeholder="<secret>{key}</secret>") # mask any potential passwords passed from AYLA to browser-use to browser-use format
