...
def print_troubleshooting():
    ...
    print("   - Make sure Ayla Agent is running: python run_ui.py")
    ...
    try:
        ...
        async with httpx.AsyncClient() as client:
            try:
                ...
                print("✅ Ayla Agent server is running")
                return True
            except httpx.ConnectError:
                print("❌ Cannot connect to Ayla Agent server")
...
def main():
    ...
    print("📋 Next Steps:")
    print("1. Start Ayla Agent server if not running")
