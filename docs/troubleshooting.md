...
This page addresses frequently asked questions (FAQ) and provides troubleshooting steps for common issues encountered while using Ayla Agent.

## Frequently Asked Questions
**1. How do I ask Ayla Agent to work directly on my files or dirs?**
-   Place the files/dirs in the `work_dir` directory. Ayla Agent will be able to perform tasks on them. The `work_dir` directory is located in the root directory of the Docker Container.
...
**3. How do I integrate open-source models with Ayla Agent?**
...
**6. How can I make Ayla Agent retain memory between sessions?**
Refer to the [How to update Ayla Agent](installation.md#how-to-update-ayla-agent) section of the documentation for instructions on how to update Ayla Agent while retaining memory and data.

**7. Where can I find more documentation or tutorials?**
-   Join the Ayla Agent [Skool](https://www.skool.com/ayla-agent) or [Discord](https://discord.gg/B8KZKNsPpj) community for support and discussions.
...
**10. Can Ayla Agent interact with external APIs or services (e.g., WhatsApp)?**
Extending Ayla Agent to interact with external APIs is possible by creating custom tools or solutions. Refer to the documentation on creating them. 
...
* **Performance Issues:** If Ayla Agent is slow or unresponsive, it might be due to resource limitations, network latency, or the complexity of your prompts and tasks, especially when using local models.