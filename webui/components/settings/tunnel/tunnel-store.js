    ...
    try {
      ...
      if (data.success && data.tunnel_url) {
        ...
        if (this.tunnelLink !== data.tunnel_url) {
          ...
          localStorage.setItem("ayla_agent_tunnel_url", data.tunnel_url);
        }
        ...
        const storedTunnelUrl = localStorage.getItem("ayla_agent_tunnel_url");
        ...
        if (storedTunnelUrl) {
          ...
          if (verifyData.success && verifyData.is_valid) {
            ...
            // Clear stale URL
            localStorage.removeItem("ayla_agent_tunnel_url");
            this.tunnelLink = "";
    ...
    try {
      ...
      if (!hasAuth) {
        const proceed = confirm(
          "WARNING: No authentication is configured for your Ayla Agent instance.\n\n" +
            "Creating a public tunnel without authentication means anyone with the URL " +
            "can access your Ayla Agent instance.\n\n" +
